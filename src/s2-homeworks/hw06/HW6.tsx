...
const HW6 = () => {
    ...
    const restore = () => {
        const restoredValue = restoreState<string>('hw6-editable-span-value', ''); // Provide an empty string as the default value
        setValue(restoredValue); // Update the state with the restored value
    };
